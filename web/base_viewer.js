 ...
 * @property {boolean} [startHiddenAnnotation] - Show/hide annotation the pages.
...
class BaseViewer {
  ...
  constructor(options) {
    ...
    this.startHiddenAnnotation = options.startHiddenAnnotation || false;
   ...
   * @param {boolean} startHiddenAnnotation
   * @param {IL10n} l10n
  ...
  createAnnotationLayerBuilder(
    ...
    return new AnnotationLayerBuilder({
      ...
      startHiddenAnnotation: this.startHiddenAnnotation,
